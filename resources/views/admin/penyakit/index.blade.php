		...
		<table class="table table-hover border">
			...
			<tbody>
				...
				<tr>
					...
					<td>{{ \Str::limit($row->pencegahan, 180) }}</td>
					<td>
			...
			<div class="row mt-2">
				<div class="col-md-12">
					<div class="form-group">
						...
						<textarea name="pencegahan" cols="30" rows="6" class="form-control"></textarea>
					</div>
				</div>
			</div>
			<div class="mt-2">
	...
	<x-modal title="Edit penyakit" id="edit-penyakit">
		<form action="{{ route('admin.penyakit.update') }}" method="POST">
			...
			<div class="row mt-2">
				<div class="col-md-12">
					<div class="form-group">
						<label for="penyebab">Keterangan Pencegahan</label>
						<textarea name="pencegahan" cols="30" rows="6" class="form-control"></textarea>
					</div>
				</div>
			</div>
		...
		<script>
			...
			$('.edit').click(function() {
				...
				$.get(`{{ route('admin.penyakit.json') }}?id=${id}`, function(res) {
					...
					$('#edit-penyakit textarea').text(res.solusi)
					$('#edit-penyakit textarea').text(res.pencegahan)
